  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-5.bgs.p-5.brad
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="Esquema general del componente formativo, que enuncia las temáticas desarrolladas y destaca aspectos clave estudiados. Tema central: fundamentos de análisis y diseño de software.Temas integradores: caracterización de procesos, ingeniería de requisitos, elicitación de requisitos y análisis y especificación de requisitos.")
      .col-auto
